...
import { Activity, Database, Settings, FileText, Menu, Cpu, Cloud, Globe, X } from 'lucide-react';
    ...
    <>
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="font-bold text-lg tracking-tight text-white">Betfair Nexus</h1>
            <span className="text-xs text-slate-500 font-mono">v2.4.0-alpha</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800 space-y-4">
        <div className="p-3 bg-slate-900 rounded-lg border border-slate-800">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-slate-400 uppercase font-semibold">System Health</span>
